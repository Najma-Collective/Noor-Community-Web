import{c as n,a as c,r as m}from"./heroImage-CFuz-Y39.js";import{a as t,b as l}from"./programmes-CLQhGAcm.js";import{a as p}from"./storyBlocks-CTpwkMXs.js";function d(o){document.title="Noor Community Programmes | English for Academic Purposes";const a=n({title:t.eap.title,body:t.eap.description,actions:[{label:"Apply for EAP",href:"./join-students.html"},{label:"Support the Scholarship Fund",href:"./donate.html"}]});o.append(a),c(a,t.eap.heroQuery);const e=document.createElement("section");e.classList.add("section"),e.innerHTML=`
    <header>
